    ...
    <div>
      ...
      <section className="bg-gradient-to-br from-blue-600 to-blue-800 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
          ...
          <div className="bg-white rounded-xl p-3 flex flex-col sm:flex-row gap-2 max-w-2xl mx-auto shadow-lg">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <FeatureCard
            ...
            text="Every worker is manually approved by admins with valid ID proof."
          />
          <FeatureCard
            icon={<MapPin className="text-blue-600" size={28} />}
            title="Nearby First"
            text="Smart location-based ranking shows you the closest available workers."
          />
          <FeatureCard
            icon={<Star className="text-blue-600" size={28} />}
            title="Real Reviews"
            text="Ratings and reviews from real customers help you choose confidently."
          />
        </div>
      </section>

      {/* Health check status (dev-only sanity check) */}
